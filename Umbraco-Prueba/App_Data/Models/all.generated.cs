...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "7e28407a5e169163")]
...
#pragma warning restore 0109
		...
		/// Text Body - SCP
		///</summary>
		[ImplementPropertyType("textBodySCP")]
		public IHtmlString TextBodyScp
		{
			get { return this.GetPropertyValue<IHtmlString>("textBodySCP"); }
		}

		///<summary>
		/// Title Page - SCP
		///</summary>
		[ImplementPropertyType("titlePageSCP")]
		public string TitlePageScp
		{
			get { return this.GetPropertyValue<string>("titlePageSCP"); }
		}
	}
